...
/**
 * Utility class for matrix operations used in the game logic.
 * Handles intersection checks, merging, and row clearing.
 */
public class MatrixOperations {
    ...
    /**
     * Checks if a brick intersects with the existing filled fields in the matrix.
     *
     * @param matrix the current board matrix.
     * @param brick  the brick shape matrix.
     * @param x      the x-coordinate of the brick.
     * @param y      the y-coordinate of the brick.
     * @return true if there is an intersection or if the brick is out of bounds,
     *         false otherwise.
     */
    ...
    /**
     * Checks if a coordinate is out of the bounds of the matrix.
     *
     ...
     * @return a ClearRow object containing the results of the operation.
     */
